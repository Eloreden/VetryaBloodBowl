...
namespace VetryaBloodBowl.DAL
{
    public class BloodBowlInitializer : DropCreateDatabaseIfModelChanges<BloodBowlContext>
    {
        protected override void Seed(BloodBowlContext context)
        {
            ...
            {
                new TeamRoster{ID = 1, Race = RaceTeam.Human, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 2, Race  = RaceTeam.Skaven, RerollQuantity = 8, RerollCost = 60000, SpecialRules = ""},
                new TeamRoster{ID = 3, Race  = RaceTeam.Nurgle, RerollQuantity = 8, RerollCost = 70000, SpecialRules = ""},
                new TeamRoster{ID = 4, Race  = RaceTeam.Dwarf, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 5, Race  = RaceTeam.ElvenUnion, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 6, Race  = RaceTeam.HightElf, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 7, Race  = RaceTeam.DarkElf, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 8, Race  = RaceTeam.WoodElf, RerollQuantity = 8, RerollCost = 50000, SpecialRules = ""},
                new TeamRoster{ID = 9, Race  = RaceTeam.Orc, RerollQuantity = 8, RerollCost = 60000, SpecialRules = "" },
            };
